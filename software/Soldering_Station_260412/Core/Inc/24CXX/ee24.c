...
/**
  * @brief  Circle Write to Memory
  * @note   Write an array to memory
  *
  * @param  *Handle: Pointer to EE24_HandleTypeDef structure
  * @param  StartAddress: First Address for available memory block
  * @param  StopAddress: Last Address for available memory block
  * @param  FullCell: flag is cell not empty
  * @param  *Data: Pointer to copy data to EEPEOM
  * @param  Len: Data length to write
  * @param  Timeout: Timeout of this operation in ms
  *
