...
//#define DEBUG_UART
//#define DEBUG_UART_PID
//#define DEBUG_UART_EEPROM
//#define DEBUG_UART_UI
#define UART_HEANDLER                            &huart6

#define VERSION                                  260612
...
#define PID_I_HOTAIR_SCALLING                    0.00001
...
#define TIM1_PSC                                 (APB2_TIM_FREQ / TIM1_COUNT_PER_SEC - 1)
#define TIM1_ARR                                 (TIM1_COUNT_PER_SEC / TIM1_FREQ - 1)

#define TIM2_FREQ                                1                             // Hz (1 - 10)
#define TIM2_COUNT_PER_SEC                       2000
#define TIM2_PSC                                 (APB1_TIM_FREQ / TIM2_COUNT_PER_SEC - 1)
#define TIM2_ARR                                 (TIM2_COUNT_PER_SEC / TIM2_FREQ - 1)

#define TIM5_FREQ                                25                            // Hz (20 - 50)
#define TIM5_COUNT_PER_SEC                       50000
#define TIM5_PSC                                 (APB1_TIM_FREQ / TIM5_COUNT_PER_SEC - 1)
#define TIM5_ARR                                 (TIM5_COUNT_PER_SEC / TIM5_FREQ - 1)

#define TIM10_FREQ                               1000                          // dont change !!!
#define TIM10_COUNT_PER_SEC                      1000000                       // if 1'000'000 one tick = 1uS
#define TIM10_PSC                                (APB2_TIM_FREQ / TIM10_COUNT_PER_SEC - 1)
#define TIM10_ARR                                (TIM10_COUNT_PER_SEC / TIM10_FREQ - 1)

#define TIM11_FREQ                               10
#define TIM11_COUNT_PER_SEC                      10000
#define TIM11_PSC                                (APB2_TIM_FREQ / TIM11_COUNT_PER_SEC - 1)
#define TIM11_ARR                                (TIM11_COUNT_PER_SEC / TIM11_FREQ - 1)

//*************************** SANITY SECTION **********************************

#define CHECK_TIMER_SANITY16(NUM, PSC, ARR) \
    _Static_assert((PSC) >= 0,     "TIM" #NUM " PSC HAVE NEGATIVE VALUE!"); \
    _Static_assert((PSC) <= 65535, "TIM" #NUM " PSC ERROR!"); \
    _Static_assert((ARR) >= 0,     "TIM" #NUM " ARR HAVE NEGATIVE VALUE!"); \
    _Static_assert((ARR) <= 65535, "TIM" #NUM " ARR ERROR!");


#define CHECK_TIMER_SANITY32(NUM, PSC, ARR) \
    _Static_assert((PSC) >= 0,          "TIM" #NUM " PSC HAVE NEGATIVE VALUE!"); \
    _Static_assert((PSC) <= 65535,      "TIM" #NUM " PSC ERROR!"); \
    _Static_assert((ARR) >= 0,          "TIM" #NUM " ARR HAVE NEGATIVE VALUE!"); \
    _Static_assert((ARR) <= 4294967295, "TIM" #NUM " ARR ERROR!");

#ifdef TIM1_FREQ
    CHECK_TIMER_SANITY16(1, TIM1_PSC, TIM1_ARR)
#endif

#ifdef TIM2_FREQ
    CHECK_TIMER_SANITY32(2, TIM2_PSC, TIM2_ARR)
#endif

#ifdef TIM5_FREQ
    CHECK_TIMER_SANITY32(5, TIM5_PSC, TIM5_ARR)
#endif

#ifdef TIM10_FREQ
    CHECK_TIMER_SANITY16(10, TIM10_PSC, TIM10_ARR)
#endif

#ifdef TIM11_FREQ
    CHECK_TIMER_SANITY16(11, TIM11_PSC, TIM11_ARR)
#endif

#if defined(DEBUG_UART_PID) || defined(DEBUG_UART_EEPROM)  || defined(DEBUG_UART_UI)
    #define DEBUG_UART
#endif
