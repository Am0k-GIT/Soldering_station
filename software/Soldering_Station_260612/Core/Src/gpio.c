...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin : EXT_SENSOR_Pin */
  GPIO_InitStruct.Pin = EXT_SENSOR_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(EXT_SENSOR_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : EN_1_Pin IRON_SENSOR_Pin EN_2_Pin */
  GPIO_InitStruct.Pin = EN_1_Pin|IRON_SENSOR_Pin|EN_2_Pin;
