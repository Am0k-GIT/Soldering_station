...
static bool flag_reload_TIM3 = true;                                           // flag for the need to overwrite TIM settings for the encoder
static bool flag_reload_TIM4 = true;                                           // flag for the need to overwrite TIM settings for the encoder
...
int main(void)
{
  ...
  Button_Init (&K_1, K_1_GPIO_Port, K_1_Pin);
  Button_Init (&K_2, K_2_GPIO_Port, K_2_Pin);
  Button_Init (&K_3, K_3_GPIO_Port, K_3_Pin);
  Button_Init (&K_4, K_4_GPIO_Port, K_4_Pin);
  Button_Init (&EN_1, EN_1_GPIO_Port, EN_1_Pin);
  Button_Init (&EN_2, EN_2_GPIO_Port, EN_2_Pin);
  Button_Init (&IRON_SENSOR, IRON_SENSOR_GPIO_Port, IRON_SENSOR_Pin);
...
void ADC_Work (void)
{
  if (flag_IT_DMA)                                                             // если АЦП отработало
  {
    ...
    temperature_IRON_TC = ADC_converter (adc_filtered[0], (calibration_entry_t*)IRON_tools[IRON_tool_number].calibration_table,
    ...
    temperature_HOTAIR_TC = ADC_converter (adc_filtered[1], (calibration_entry_t*)HOTAIR_tools.calibration_table, TABLE_SIZE(HOTAIR_tools.calibration_table));
...
void ST7735_Update (void)
{
  ...
  switch (menu)
  {
    ...
    case (3):
      ...
      ST7735_showMenu_3 ((preset_t*)&IRON_presets, IRON_PRESETS, (settings_t*)&IRON);
    ...
    case (4):
      ...
      ST7735_showMenu_3 ((preset_t*)&HOTAIR_presets, HOTAIR_PRESETS, (settings_t*)&HOTAIR);
...
void ST7735_showMenu_5_p1 (void)
{
  ...
  encoder_uploader (&htim3, &flag_reload_TIM3, (uint16_t*)&calibration_correction, 0, LIM_CALIBRATION_RANGEWIDTH, 1);
...
void ST7735_showMenu_5_p2 (tools_t *tool)
{
  ...
  switch (selected_item)
  {
    ...
    case 3:
      ...
      break;
    case 4:
      encoder_uploader (&htim4, &flag_reload_TIM4, (uint16_t*)&tool->calibration_table[0].raw_value, LIM_MIN_ADC, LIM_MAX_ADC, LIM_STEP_ADC);
      break;
    case 5:
      encoder_uploader (&htim4, &flag_reload_TIM4, (uint16_t*)&tool->calibration_table[1].raw_value, LIM_MIN_ADC, LIM_MAX_ADC, LIM_STEP_ADC);
      break;
    case 6:
      encoder_uploader (&htim4, &flag_reload_TIM4, (uint16_t*)&tool->calibration_table[2].raw_value, LIM_MIN_ADC, LIM_MAX_ADC, LIM_STEP_ADC);
      break;
    case 7:
      encoder_uploader (&htim4, &flag_reload_TIM4, (uint16_t*)&tool->calibration_table[3].raw_value, LIM_MIN_ADC, LIM_MAX_ADC, LIM_STEP_ADC);
      break;
  }
}
//*****************************************************************************
...
void EEPROM_Read_All (void)
{
  if (EE24_ReadCircle (&ee24, EEPROM_IRON_SETTINGS_START, EEPROM_IRON_SETTINGS_STOP, CTRL_BYTE, (uint8_t*)&IRON, sizeof(IRON), 10))
  {
  ...
  if (EE24_ReadCircle (&ee24, EEPROM_HOTAIR_SETTINGS_START, EEPROM_HOTAIR_SETTINGS_STOP, CTRL_BYTE, (uint8_t*)&HOTAIR, sizeof(HOTAIR), 10))
  {
  ...
  if (EE24_ReadCircle (&ee24, EEPROM_HW_SETTINGS_START, EEPROM_HW_SETTINGS_STOP, CTRL_BYTE, (uint8_t*)&HW_SET, sizeof(HW_SET), 10))
  {
  ...
  if (EE24_ReadCircle (&ee24, EEPROM_IRON_TOOLS_START, EEPROM_IRON_TOOLS_STOP, CTRL_BYTE, (uint8_t*)&IRON_tools, sizeof(IRON_tools), 10))
  {
  ...
  if (EE24_ReadCircle (&ee24, EEPROM_HOTAIR_TOOLS_START, EEPROM_HOTAIR_TOOLS_STOP, CTRL_BYTE, (uint8_t*)&HOTAIR_tools, sizeof(HOTAIR_tools), 10))
  {
  ...
  if (EE24_ReadCircle (&ee24, EEPROM_IRON_PRESETS_START, EEPROM_IRON_PRESETS_STOP, CTRL_BYTE, (uint8_t*)&IRON_presets, sizeof(IRON_presets), 10))
  {
  ...
  if (EE24_ReadCircle (&ee24, EEPROM_HOTAIR_PRESETS_START, EEPROM_HOTAIR_PRESETS_STOP, CTRL_BYTE, (uint8_t*)&HOTAIR_presets, sizeof(HOTAIR_presets),
                       10))
  {
...
void EEPROM_Write_All (void)
{
  ...
  {
    EE24_WriteCircle (&ee24, EEPROM_IRON_SETTINGS_START, EEPROM_IRON_SETTINGS_STOP, CTRL_BYTE, (uint8_t*)&IRON, sizeof(IRON), 10);
    flag_write_IRON_settings = false;
  }

  if (flag_write_HOTAIR_settings)
  {
    EE24_WriteCircle (&ee24, EEPROM_HOTAIR_SETTINGS_START, EEPROM_HOTAIR_SETTINGS_STOP, CTRL_BYTE, (uint8_t*)&HOTAIR, sizeof(HOTAIR), 10);
    flag_write_HOTAIR_settings = false;
  }

  if (flag_write_HW_settings)
  {
    EE24_WriteCircle (&ee24, EEPROM_HW_SETTINGS_START, EEPROM_HW_SETTINGS_STOP, CTRL_BYTE, (uint8_t*)&HW_SET, sizeof(HW_SET), 10);
    flag_write_HW_settings = false;
  }

  if (flag_write_IRON_tools)
  {
    EE24_WriteCircle (&ee24, EEPROM_IRON_TOOLS_START, EEPROM_IRON_TOOLS_STOP, CTRL_BYTE, (uint8_t*)&IRON_tools, sizeof(IRON_tools), 10);
    flag_write_IRON_tools = false;
  }

  if (flag_write_HOTAIR_tools)
  {
    EE24_WriteCircle (&ee24, EEPROM_HOTAIR_TOOLS_START, EEPROM_HOTAIR_TOOLS_STOP, CTRL_BYTE, (uint8_t*)&HOTAIR_tools, sizeof(HOTAIR_tools), 10);
    flag_write_HOTAIR_tools = false;
  }

  if (flag_write_IRON_presets)
  {
    EE24_WriteCircle (&ee24, EEPROM_IRON_PRESETS_START, EEPROM_IRON_PRESETS_STOP, CTRL_BYTE, (uint8_t*)&IRON_presets, sizeof(IRON_presets), 10);
    flag_write_IRON_presets = false;
  }

  if (flag_write_HOTAIR_presets)
  {
    EE24_WriteCircle (&ee24, EEPROM_HOTAIR_PRESETS_START, EEPROM_HOTAIR_PRESETS_STOP, CTRL_BYTE, (uint8_t*)&HOTAIR_presets, sizeof(HOTAIR_presets),
                      10);
...
void Button_React ()
{
  switch (menu)
  {
    //*************************************************************************
    case (0):                                    // Loading Screen
      if (K_1.Event != BTN_NONE)
      {
        ButtonEvent_t event = K_1.Event;
        K_1.Event = BTN_NONE;
      ...
      if (K_2.Event != BTN_NONE)
      {
        ButtonEvent_t event = K_2.Event;
        K_2.Event = BTN_NONE;
        if (event == BTN_SHORT_PRESS)
        {
      ...
      if (K_3.Event != BTN_NONE)
      {
        ButtonEvent_t event = K_3.Event;
        K_3.Event = BTN_NONE;
        if (event == BTN_SHORT_PRESS)
        {
      ...
      if (K_4.Event != BTN_NONE)
      {
        ButtonEvent_t event = K_4.Event;
        K_4.Event = BTN_NONE;
        if (event == BTN_SHORT_PRESS)
        {
    ...
    case (1):                                  // Main Screen
      ...
      if (EN_1.Event != BTN_NONE)
      {
        ButtonEvent_t event = EN_1.Event;
        EN_1.Event = BTN_NONE;
        if (event == BTN_SHORT_PRESS)
        {
          flag_IRON_WAKEUP = true;
      ...
      if (EN_2.Event != BTN_NONE)
      {
        ButtonEvent_t event = EN_2.Event;
        EN_2.Event = BTN_NONE;
        if (event == BTN_SHORT_PRESS)
        {
          flag_HOTAIR_WAKEUP = true;
  ...
  if (IRON_SENSOR.Event != BTN_NONE)
  {
    IRON_SENSOR.Event = BTN_NONE;
    if (IRON.sensor)
      flag_IRON_WAKEUP = true;
  }
}
