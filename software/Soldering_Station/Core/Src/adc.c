...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB0     ------> ADC1_IN8
    */
    HAL_GPIO_DeInit(GPIOC, ONBOARD_NTC_Pin|HOTAIR_NTC_Pin);

    HAL_GPIO_DeInit(GPIOA, HOTAIR_TC_Pin|IRON_TC_Pin|IRON_NTC_Pin|IRON_POWER_Pin);

    HAL_GPIO_DeInit(VOLTAGE_24V_GPIO_Port, VOLTAGE_24V_Pin);
