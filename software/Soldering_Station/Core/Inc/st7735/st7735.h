...
#define ST7735_RES_Pin       GPIO_PIN_4       // RES Pin
#define ST7735_RES_GPIO_Port GPIOB
#define ST7735_CS_Pin        GPIO_PIN_12      // CS Pin
#define ST7735_CS_GPIO_Port  GPIOC
#define ST7735_DC_Pin        GPIO_PIN_2       // RS Pin
#define ST7735_DC_GPIO_Port  GPIOD

// SDA - it is SPI-MOSI Pin
// SCK - it is SPI-SCK  Pin
// LED-A pin connected to 3.3V through 10 Ohm resistor
